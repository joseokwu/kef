...
const PoweredBy = () => {
  return (
    ...
    <div className="py-[4.1rem] px-[3.9rem] sidebar:px-[5.9rem]  bg-party rounded-[2rem] bg-cover flex-1">
      <h3 className="mb-[1.92rem] font-bold text-[4.4rem] max-w-[408px] text-[#FAFAFA] leading-[4.8rem]">Kennis Music Easter Fiesta, 2022</h3>
