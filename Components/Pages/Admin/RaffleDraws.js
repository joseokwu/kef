  ...
  return (
    <div className="flex flex-wrap gap-16">
      <div
        ...
        className=" flex-2 relative bg-[#F0F0F0] rounded-[2rem] max-w-[59.1rem] py-[3.9rem] px-[3.5rem] text-[1rem] min-w-[20rem] hover:scale-[1.01] hover:shadow-sm cursor-pointer"
      >
      ...
      <div
        ...
        className="flex-2 relative bg-[#FFF6E4] min-w-[20rem] rounded-[2rem] max-w-[59.1rem] py-[3.9rem] px-[3.5rem] hover:scale-[1.01] hover:shadow-sm cursor-pointer"
      >
