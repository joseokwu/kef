...
const Cards = () => {
  ...
  const navs = ["All Cards", "New Cards", "Won Cards"];
  const data = [
    { firstName: "Jonathan", lastName: "Mcreynold", DatePurchased: "21 March, 2022", pickupStatus: "Delivered", phone: "+234(0)812 3456789", email: "j.mcreynold@gmail.com" },
    { firstName: "Jonathan", lastName: "Smith", DatePurchased: "21 March, 2022", pickupStatus: "Not Delivered", phone: "+234(0)812 3456789", email: "jonsmith@gmail.com" },
    { firstName: "Jonathan", lastName: "Mcreynold", DatePurchased: "21 March, 2022", pickupStatus: "Delivered", phone: "+234(0)812 3456789", email: "j.mcreynold@gmail.com" },
    { firstName: "Jonathan", lastName: "Mcreynold", DatePurchased: "21 March, 2022", pickupStatus: "Delivered", phone: "+234(0)812 3456789", email: "j.mcreynold@gmail.com" },
    { firstName: "Jonathan", lastName: "Smith", DatePurchased: "21 March, 2022", pickupStatus: "Not Delivered", phone: "+234(0)812 3456789", email: "jonsmith@gmail.com" },
  ];
        ...
        <table className=" w-full  border-collapse">
          <thead className="text-bl text-black-light whitespace-nowrap bg-gray-lightest-2  caption_heavy h-[48px] font-medium ">
            <tr className="">
              ...
              <th className="border-b border-gray-lighter font-medium text-left pt-[10px] px-[16px]">
                <span className=" align-text-bottom mt-auto text-[#A1A1A1] font-medium text-[1.2rem]">Pick up Status</span>
              </th>
                ...
                <>
                  <tr className="">
                    ...
                    <td className=" border-gray-lighter p-[16px] text-left align-text-bottom font-semibold text-[1.2rem]">
                      <span className={`px-[11px] text-lg font-semibold py-[5px] rounded-full ${el.pickupStatus == "Not Delivered" ? " bg-[#F6E2E2] text-[#8D3333]" : "bg-[#E2F6E9] text-[#338D4F]"}`}>
                        {el.pickupStatus}
                      </span>
                    </td>
