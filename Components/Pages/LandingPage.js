        ...
        <main className="h-full">
          <div>
            ...
            <p className=" font-medium text-[1.4rem] mobile:text-[1.6rem] leading-[2rem] mobile:leading-[2.6rem] text-white mt-[2.4rem] mobile:mt-[3.1rem] mb-[6.5rem] max-w-[58.7rem]">
              {/* Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra sodales vestibulum nullam amet, tempus iaculis. Eget sagittis cursus amet. */}A curated celebration of Nigerian Music
              and Nigerians in Music with a salacious tint of Comedy, Art, Movies, and all Creative Exercises
            </p>
          </div>
