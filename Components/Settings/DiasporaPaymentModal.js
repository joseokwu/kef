...
const DiasporaPaymentModal = ({ setModal, modal }) => {
        ...
        <div className='content'>
          <div className='title'>
            ...
            <p className='subtitle'>
              Set amount and currency for foreign users
            </p>
          </div>
          ...
          <SelectBox
            label={'Currency'}
            subtitle={'Choose a currency to be paid in'}
            disabled={false}
            options={['Naira', 'Dollars']}
            // type='number'
          />
...
export default DiasporaPaymentModal;
