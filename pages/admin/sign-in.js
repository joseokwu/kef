...
const AdminSignIn = () => {
  ...
  const onLogin = async (user) => {
    login({ user, toggleLoad, toggleAlertBar, router, setPassError });
  };
  ...
  return (
    <div className='auth-container !mb-[10rem]'>
      ...
      >
        ...
        <p className='mb-[4.4rem]'>Hey there! Welcome back</p>
        {passError && (
          <p className=' !text-[1.4rem] !text-red-500'>*{passError}</p>
        )}
...
AdminSignIn.Layout = AdminAuthLayout;
